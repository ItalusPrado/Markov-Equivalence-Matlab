function resultado = MarkovEquiv(arrayQ1,arrayQ2)
...
%Verificando se possuem mesmo esqueleto
firstTest = isequal(markov1,markov2);

%---------- Verificando se possuem mesma imoralidade ---------

% --------- Pegando posição das ligações em V
imoralities1 = [];
imoralities2 = [];
